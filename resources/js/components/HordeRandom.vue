        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div style="height: 450px" class="card">
                    <div class="card-header">Pokemon or Medication? - Find the Medication Hiding!</div>
                        ...
                        <template v-if="whichSix(0)">
                            <button style="width:200px; margin: 0 auto" class="btn btn-primary mt-2 pb-2" v-on:click="minusOne" v-text="pokemon1"></button>
                            <button style="width:200px; margin: 0 auto" class="btn btn-primary mt-2 pb-2" v-on:click="minusOne" v-text="pokemon2"></button>
                            <button style="width:200px; margin: 0 auto" class="btn btn-primary mt-2 pb-2" v-on:click="minusOne" v-text="pokemon3"></button>
                            <button style="width:200px; margin: 0 auto" class="btn btn-primary mt-2 pb-2" v-on:click="minusOne" v-text="pokemon4"></button>
                            <button style="width:200px; margin: 0 auto" class="btn btn-primary mt-2 pb-2" v-on:click="minusOne" v-text="pokemon5"></button>
                            <button style="width:200px; margin: 0 auto" class="btn btn-primary mt-2 pb-2" v-on:click="plusOne" v-text="medicine"></button>
                        </template>
